...
import { HiBolt, HiCircleStack, HiLifebuoy, HiMiniSquare3Stack3D, HiQrCode, HiServerStack, HiShieldCheck, HiSwatch, HiWrenchScrewdriver } from 'react-icons/hi2'

export default function Feature() {
    return (
        <div className="text-left max-w-7xl px-6 w-full mx-auto">
            <div className="text-left max-w-2xl mx-auto">
                <h2 className="text-base font-semibold leading-7 text-indigo-500">Everything you need</h2>
                <p className="mt-2 text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100  sm:text-4xl">No server? No problem.</p>
                <p className="mt-6 text-lg leading-8 dark:text-gray-300 text-gray-700">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis.</p>
            </div>
            <dl className="text-left mt-16 grid max-w-2xl grid-cols-1 gap-12 text-base leading-7 text-slate-700 dark:text-slate-300 sm:grid-cols-2 mx-auto ctb cxh czq">
                ...
                <div className="relative pl-9 max-w-full flex flex-col">
                    <dt className="whitespace-nowrap font-semibold text-slate-100 mr-1 flex items-center"><HiCircleStack className='absolute left-1 top-1 h-6 w-6 text-indigo-500' /> Veritabanı Yönetimi.</dt>
